...
Do not run git commands, stage files, create commits, change branches, or modify any
repository outside the assigned workspace. Version-control operations are not part
